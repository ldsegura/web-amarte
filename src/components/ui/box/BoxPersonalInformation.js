    ...
    >
      ...
      <div className="boxicons-small">
        {linkFacebook && (
          ...
          >
            <Image src={iconfacebook.src} alt="red social facebook" />
          </a>
        )}
        {linkInstagram && (
          <a
          ...
          >
            <Image src={iconinstagram.src} alt="red social instagram" />
          </a>
        )}
        {linkTwitter && (
          <a
          ...
          >
            <Image src={icontwitter.src} alt="red social twitter" />
          </a>
        )}
        {linkWhatsapp && (
          <a
        ...
        {linkLinkedin && (
          ...
          >
            <Image src={iconlinkein.src} alt="red social linkein" />
          </a>
        )}
      </div>
      {show && (
